...
int main(int argc, char** argv) {
    ...
    cout << "#-------------------------------" << endl;
    dist_original.distance_graphs<distance::mcs>(shortest_path, distance_relation, 0.1f, 0.1f);
    dist_yandex.distance_graphs<distance::mcs>(shortest_path, distance_relation, 0.1f, 0.1f);
}
