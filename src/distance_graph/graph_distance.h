    ...
    namespace distance {
        ...
        class WN_DISTANCE_GRAPH_EXPORT base_graph {
            public:
                ...
                float max_similarity(const conceptual_graph& s1, const conceptual_graph& s2, float synset_tolerance, float relation_tolerance) const;
                float max_similarity(const conceptual_graph& s1, const conceptual_graph& s2,
