...
sólo es posible si se acepta esta hipótesis como válida, los conceptos son independientes
y anteriores al lenguaje en el que se articulan y, por lo tanto, pueden ser representados
independientemente de éste [#]_.
...
que propondremos. El capítulo 3 se expone el problema que tratamos de abordar, el 
capítulo 4 muestra las limitaciones y restricciones a las que nos vemos sometidos o 
que tenemos que asumir a la hora de abordar el problema. En el capítulo 5 se expone
...
de investigación y de trabajo que deben continuarse para contribuir a la
