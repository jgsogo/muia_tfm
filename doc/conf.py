# -*- coding: utf-8 -*-
#
# Medida de distancia en grafos UNL documentation build configuration file, created by
...
htmlhelp_basename = 'MedidadedistanciaengrafosUNLdoc'
...
#epub_basename = u'Medida de distancia en grafos UNL'
